...
echo ""
echo "TTS voice quality (primary → fallback):"
echo "  1. piper-tts  Open-source neural TTS, runs offline on CPU  ← primary"
echo "                Voice models auto-download to ~/.cache/piper/voices"
echo "                Override location via PIPER_VOICE_DIR"
echo "  2. edge-tts   Microsoft neural voices (requires internet)"
